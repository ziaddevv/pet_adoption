...
public class HandleFiles {
    ...
    private static final String PET_FILE = "Pet_Adoption_Dawley/Pet_Adoption/pets.txt";
    private static final String SHELTERS_FILE = "Pet_Adoption_Dawley/Pet_Adoption/shelters.txt";
    private static final String USERS_FILE = "Pet_Adoption_Dawley/Pet_Adoption/users.txt";
    private static final String ADOPTIONS_FILE = "Pet_Adoption_Dawley/Pet_Adoption/adoptions.txt";
    private static final String NOTIFICATIONS_FILE = "Pet_Adoption_Dawley/Pet_Adoption/notifications.txt";
    ...
    public static List<Notifications> loadNotifications() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(NOTIFICATIONS_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                boolean IsReaded = Boolean.parseBoolean(parts[6]);
                notifications.add(new Notifications(id,adopterID,adminID,petID,status,IsReaded,IssueDate));
                maxID=Math.max(maxID,id);
            }
        }
    ...
    public static void saveNotifications(List<Notifications> notifications) throws IOException {
